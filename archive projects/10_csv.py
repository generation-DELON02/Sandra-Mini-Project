...
#Drinks_list  = ["name" : "Margarita" "price": "80p", "Fanta"]
#Courier_list = ["Uber", "Deliveroo", "Just eat"]
order_list1 = ["customer_name: " ,"customer_address:  " ,"customer_phone:  " ,"courier:   " , "status:  "]
#Drinks_list = []
#open file r > pass file in object to Dictread to get to the dictreader obj> get a list
Drinks_list = []
def read_drinks():
...
# def read_drinks():
#     with open("Drinks_list.csv", 'r', ) as file:
...
#def save_courier():
    #with open('courier_list.csv','w', newline='') as g:
        #delivery= '\n'.join(Courier_list)
        #g.write(delivery)
