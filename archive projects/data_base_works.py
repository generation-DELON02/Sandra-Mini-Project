#try what you did for order user_input_3 for orders on couriers
import csv 
...
def courier_selection():
    ...
    print('You have selected this one')
...
def update_courier_phone(courier_to_be_updated):
    ...
    if user_input_courier_phone =="":
        ...
        sql = "UPDATE Courier_table SET Courier_phone = %s Where Courier_id = %s"
...
def first_menu():
    ...
    data_input = int(input("Please press 3 to see Order Menu \nPlease Press 2 to see Courier Menu \nPlease click '1' to see the drinks menu \nPlease click '0' to exit the app"))
    if data_input == 3:
        print("***Welcome to the Order Menu***")
        order_menu()
    elif data_input ==2:
